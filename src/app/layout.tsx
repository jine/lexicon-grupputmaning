				...
				<div className="flex min-h-screen">
					<aside className="w-60 fixed left-0 top-0 bottom-0 border-r border-[#2a2a2a] bg-[#0f0f0f]">
						<div className="h-14 flex items-center px-4 border-b border-[#2a2a2a]">
							<svg
								className="w-5 h-5 text-[#00d4aa] mr-2"
								fill="none"
								viewBox="0 0 24 24"
								stroke="currentColor"
							>
						...
						<nav className="p-2">
							<a
								href="/"
								className="flex items-center gap-3 px-3 py-2 text-sm text-[#f5f5f5] bg-[#1a1a1a] rounded"
							>
								<svg
							...
							<Link
								href="/"
								className="flex items-center gap-3 px-3 py-2 text-sm text-[#888] hover:text-[#f5f5f5] hover:bg-[#1a1a1a] rounded"
							>
								<svg
									className="w-4 h-4"
									fill="none"
